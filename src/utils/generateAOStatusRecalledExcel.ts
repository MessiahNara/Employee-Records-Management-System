...
/**
 * Isolated service to generate the AO Status Recalled Excel buffer.
 */
export default async function generateAOStatusRecalledExcel(data: AOStatusExportData): Promise<Buffer> {
  const workbook = new ExcelJS.Workbook();
  const worksheet = workbook.addWorksheet('AO Status Recalled');
