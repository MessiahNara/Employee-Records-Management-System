      ...
      <div className="file201-history">
        ...
        {!loading && logs.length === 0 && (
          <div className="file201-history__empty">
            <p>No borrow/return records found for this employee.</p>
          </div>
        )}
          ...
          <div className="file201-history__list">
            {logs.map((log) => {
              ...
              return (
                <div
                  key={log.id}
                  className={`file201-history__item ${isBorrow ? 'file201-history__item--borrowed' : 'file201-history__item--returned'}`}
                >
                  <div className="file201-history__item-header">
                    <div className="file201-history__badges">
                      <span className={`file201-history__badge ${isBorrow ? 'file201-history__badge--borrowed' : 'file201-history__badge--returned'}`}>
                        {isBorrow ? '📤 BORROWED' : '📥 RETURNED'}
                      </span>
                      {isReturned && log.fileCondition && log.fileCondition !== 'Complete' && (
