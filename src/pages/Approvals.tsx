    ...
    switch (req.action) {
      ...
      case 'update_user': {
        const FIELD_LABELS: Record<string, string> = {
          ...
          detailedOrderFrom: 'Detailed Order (From)',
          detailedOrderTo: 'Detailed Order (To)',
          designatedPositionFunction: 'Designated Position Function',
          designatedOrderFrom: 'Designated Order (From)',
          designatedOrderTo: 'Designated Order (To)',
          recalledFrom: 'Recalled From',
          recalledTo: 'Recalled To',
          recalledOrderFrom: 'Recalled Order (From)',
