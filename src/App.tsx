...
import ScanningStatus from './pages/ScanningStatus';
import OfficeScanningStatus from './pages/OfficeScanningStatus';
        ...
        <IdleTimeoutProvider>
          <Routes>
            ...
            >
              ...
              />
              <Route 
                path="scanning-status/office" 
                element={
                  <RoleProtectedRoute allowedRoles={['superadmin', 'admin', 'developer']}>
                    <OfficeScanningStatus />
                  </RoleProtectedRoute>
                } 
              />
